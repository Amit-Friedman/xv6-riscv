...
extern uint64 sys_kernel_lcg_srand(void);
extern uint64 sys_kernel_lcg_rand(void);
...
[SYS_mkdir]   sys_mkdir,
[SYS_close]   sys_close,
[SYS_kernel_lcg_srand]  sys_kernel_lcg_srand,
[SYS_kernel_lcg_rand]  sys_kernel_lcg_rand,
